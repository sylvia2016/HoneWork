namespace HomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static 清單檢視表Repository Get清單檢視表Repository()
		{
			var repository = new 清單檢視表Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 清單檢視表Repository Get清單檢視表Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 清單檢視表Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
